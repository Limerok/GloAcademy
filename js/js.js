...
buttonExpensesAdd = document.getElementsByTagName('button')[1],//добавить доп.расход
inputMission = document.querySelector('.target-amount'),//Цель
inputSalaryAmount = document.querySelector('.salary-amount'),//Месячный дох//Период для цели
...
//Возможные доходы
inputAdditionalIncomeOne = document.querySelectorAll('.additional_income-item')[0],//возможный доход 1
inputAdditionalIncomeOneTwo = document.querySelectorAll('.additional_income-item')[1],//возможный доход 2
//Дополнительные доходы
inputIncomeTitle = document.querySelector('.income-title'),//Наименование
inputIncomeAmount = document.querySelector('.income-amount'),//Сумма
//Возможные расходы
...
//Правые элементы
resultBudgetMonth = document.getElementsByClassName('budget_month-value'),//Доход за месяц
resultBudgetDay = document.getElementsByClassName('budget_day-value'),//Дневной бюджет
resultExpensesMonth = document.getElementsByClassName('expenses_month-value'),//Расход за месяц
resultAdditionalIncome = document.getElementsByClassName('additional_income-value'),//Возможные доходы
resultAdditionalExpenses = document.getElementsByClassName('additional_expenses-value'),//Возможные расходы
resultIncomePeriod = document.getElementsByClassName('income_period-value'),//Накопления за период
resultTargetMonth = document.getElementsByClassName('target_month-value');//Срок до цели
